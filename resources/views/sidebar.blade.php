...
<html lang="en">
  ...
  <body>
  <div class="footer">
  <div style="position:absolute;left:1270px; top:16px;color:#FD8469;"><a href="{{ route('logout') }}" class="btn btn-danger">Keluar</a></div>
...
<div class="sd" style="padding-left:15px;">{{ Auth::user()->name }}
</div>
