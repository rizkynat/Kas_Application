  ...
  <div class="card container mt-3" style="width:810pt; background:#FFC947">
	...
	<form action="<?php echo e(url('cari')); ?>" method="GET">
		...
		<input type="text" name="name" placeholder="Cari ?" class="form-control"></br>
       ...
       function rupiah($angka){
        ...
        ?>
                ...
                <tr>
                    ...
                    <td><?php echo rupiah($RS->harga);?></td>
                    <td><?php echo e($RS->jumlah); ?></td> 
                    <td><?php echo e($RS->tanggal); ?></td> 
                    <td><?php echo rupiah($RS->total_hrg);?></td> 
                    <?php $no++;$jumlah=$RS->total_hrg+$jumlah; ?>
                    <td><a class="btn btn-primary" href="../public/edit/<?php echo e($RS->id_brg); ?>" style="width:45px; height:30px;">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <a class="btn btn-danger" href="../public/hapus/<?php echo e($RS->id_brg); ?>" style="width:45px; height:30px;">
                     <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" style="margin-bottom:20px;">
        ...
        <div class="card-body">
          <h5>Jumlah pengeluaran:</h5><h5 style="color:green"> <b>Rp <?php print  number_format($jumlah,2,',','.');?></b>
</div>
    </div>
