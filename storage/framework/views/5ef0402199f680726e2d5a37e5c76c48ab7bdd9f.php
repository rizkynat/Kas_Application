       ...
       function rupiah($angka){
        ...
        ?>
                ...
                <tr>
                    <td><?php echo e($no); ?></td>
                    <?php $no++; ?>
                    <td><?php echo e($RS->no_kas); ?></td>
                    <td><?php echo rupiah($RS->jumlah_kas);?></td>
                    <td><?php echo e($RS->tgl_kas); ?></td>
                    <?php $no++;$jumlah=$RS->jumlah_kas+$jumlah; ?>
                    <td><a class="btn btn-primary" href="../public/editKas/<?php echo e($RS->id_kas); ?>" style="width:45px; height:30px;">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
                     ...
                     <a class="btn btn-danger" href="../public/hapusKas/<?php echo e($RS->id_kas); ?>" style="width:45px; height:30px;"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16" style="margin-bottom:20px;">
...
<?php echo $__env->make('sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/uasLar/resources/views/kas.blade.php ENDPATH**/ ?>